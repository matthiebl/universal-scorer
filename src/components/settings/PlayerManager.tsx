            ...
            <div className="flex items-center gap-1 px-3 py-2">
              ...
              <div className="flex flex-col gap-0.5">
                ...
                <button
                  ...
                  className={cn('p-1 text-zinc-400 hover:text-zinc-700 dark:hover:text-zinc-200', i === sorted.length - 1 && 'opacity-30')}
              ...
              <div className="w-7 h-7 mx-2 rounded-full shrink-0" style={{ backgroundColor: player.color }} />
